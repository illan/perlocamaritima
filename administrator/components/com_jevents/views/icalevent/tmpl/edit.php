 ...
 *
 * @version     $Id: edit.php 1854 2010-10-07 08:59:03Z geraint $
 * @package     JEvents
...
?>
<div id="jevents" <?php $params=JComponentHelper::getParams(JEV_COM_COMPONENT);echo (!$mainframe->isAdmin() && $params->get("darktemplate",0))?"class='jeventsdark'":"";?>>
 ...
 ?>
    ...
    <table cellpadding="5" cellspacing="2" border="0"  class="adminform" id="jevadminform">
        ...
        <tr>
            ...
            <?php 
            echo JEventsHTML::buildCategorySelect($catid, '', $this->dataModel->accessibleCategoryList(), $this->with_unpublished_cat, true,0,'catid',JEV_COM_COMPONENT, $this->excats);
            ?>
            </td>
            <?php
            }
